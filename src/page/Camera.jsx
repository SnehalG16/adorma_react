      ...
      <div>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {data.length > 0 && data && data.map((el, index) => (
              <div key={index} className='card1' style={{ display: "flex" }}>
                {/* <h3 style={{height:"15px",width:"10px",backgroundColor:"green"}}>{el.Label}</h3>*/}
                <div><Link to={`/singlepage/${el.id}`}><img src={el.img ? el.img[0]:"https://www.adorama.com/images/product/TF4565DVSK3.jpg"} alt="" style={{ margin: "20px", height: "300px", width: "250px" }} />
